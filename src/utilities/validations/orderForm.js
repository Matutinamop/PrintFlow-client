...
export const printTaskModuleSchema = Joi.object({
	...
	finalSize: Joi.string()
		...
		.messages({
			...
			'any.required':
				'El campo "Medida final" es obligatorio',
		}),
	...
	sheetSize: Joi.string()
		...
		.messages({
			...
			'any.required':
				'El campo "Pliego de impresión" es obligatorio',
		}),
	...
	postureCost: Joi.alternatives()
		...
		.allow(''),
	moduleRepeat: Joi.string()
		.pattern(numbersRegex)
		.allow(1)
		.messages({
			'string.pattern.base':
				'"Repetir modulo" debe ser un numero',
			'any.required':
				'El campo "Repetir modulo" es obligatorio',
		}),
...
export const orderSchema = Joi.object({
	...
	dateEstimate: Joi.date().allow('').messages({
		'any.required':
			'El campo "Fecha estimada" es obligatorio',
	}),
	dateFinal: Joi.date().allow('').messages({
		'date.greater':
