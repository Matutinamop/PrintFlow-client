...
const useCalculateFields = (
  ...
  useEffect(() => {
    if (material) {
      const newOptions = material?.grammage?.map((grammage, index) => ({
        key: index,
        value: grammage,
        label: grammage,
      }));
      ...
      setFields((prev) => {
        ...
        updatedPrintTasks[index].grammageOptions = newOptions;
        return {
          ...prev,
  ...
  useEffect(() => {
    if (material) {
      const newOptions = material?.sizes?.map((size, index) => ({
        key: index,
        value: size,
        label: size,
      }));
      ...
      setFields((prev) => {
        const updatedPrintTasks = [...prev.printTasks];
        updatedPrintTasks[index].sizeMaterialOptions = newOptions;
        return {
          ...prev,
          printTasks: updatedPrintTasks,
        };
  ...
  useEffect(() => {
    ...
    if (quickMaterial && Object.keys(quickMaterial).length > 0) {
      newOptions.push({
      ...
      setFields((prev) => {
        ...
        updatedPrintTasks[index]['material'] = quickMaterial._id;
        return {
          ...prev,
          printTasks: updatedPrintTasks,
        };
  ...
  useEffect(() => {
    ...
    setFields((prev) => {
      const updatedPrintTasks = [...prev.printTasks];
      updatedPrintTasks[index].operationOptions = newOptions;
      return {
        ...prev,
        printTasks: updatedPrintTasks,
      };
  ...
  useEffect(() => {
    if (module.bulkPaperSize && module.sheetSize) {
      setFields((prev) => {
        const updatedPrintTasks = [...prev.printTasks];
        updatedPrintTasks[index].sheetPerBulkPaper = calculateItemInArea(
    ...
    if (module.sheetSize && module.sizeWithMargins) {
      setFields((prev) => {
        const updatedPrintTasks = [...prev.printTasks];
        updatedPrintTasks[index].unitsPerSheet = calculateItemInArea(
          module.sheetSize,
    ...
    if (module.excess && module.sheetQuantity && module.sheetPerBulkPaper) {
      setFields((prev) => {
        const updatedPrintTasks = [...prev.printTasks];
        updatedPrintTasks[index].bulkPaperQuantity = bulkPaperQuantity(
    ...
    if (
      ...
      setFields((prev) => {
        const updatedPrintTasks = [...prev.printTasks];
        updatedPrintTasks[index].costPerBulkPaper = paperCostByWeight(
          paperWeight,
    ...
    if (module.sheetQuantity && module.postures) {
      setFields((prev) => {
        ...
        updatedPrintTasks[index].printRun =
          (module.sheetQuantity + parseInt(module.excess)) * module.postures;
        return {
          ...prev,
          printTasks: updatedPrintTasks,
        };
    ...
    if (module.operation && module.plates) {
      ...
      setFields((prev) => {
        const updatedPrintTasks = [...prev.printTasks];
        updatedPrintTasks[index].plateCost = selectedOperation.plateCost
          ? Math.round(selectedOperation.plateCost * module.plates)
          : 0;
        return {
          ...prev,
          printTasks: updatedPrintTasks,
    ...
    if (module.operation && module.postures && module.printRun) {
      const selectedOperation = operations.find(
        (op) => op._id === module.operation
      );
      setFields((prev) => {
        const updatedPrintTasks = [...prev.printTasks];
        updatedPrintTasks[index].postureCost = costCalculator(
          selectedOperation,
          module.printRun
        );
        return {
    ...
    setFields((prev) => {
      const updatedPrintTasks = [...prev.printTasks];
      updatedPrintTasks[index].printCost = printCost(module);
      return {
        ...prev,
        printTasks: updatedPrintTasks,
      };
    ...
    setFields((prev) => {
      const updatedPrintTasks = [...prev.printTasks];
      updatedPrintTasks[index].estimatedCost = printModuleCost(module);
      return {
        ...prev,
        printTasks: updatedPrintTasks,
      };
    ...
    if (!manualChanges.totalCost) {
      setFields((prev) => {
        const updatedPrintTasks = [...prev.printTasks];
        updatedPrintTasks[index].totalCost = printModuleCost(module);
        return {
          ...prev,
          printTasks: updatedPrintTasks,
        };
