            ...
            <div className={styles.documentContent}>
              <div className={styles.mopHeader}>
                ...
                <div className={`${styles.headerBlock} ${styles.infoHeader} `}>
                  ...
                  >
                    Fecha de Creación:{' '}
                    <span>{toFormatDate(order?.dateCreated)}</span>
                  </p>
                  <p
                    style={{
                      display: 'flex',
              ...
              <div className={`${styles.blockContainer} ${styles.noBreak}`}>
                ...
                <div className={styles.rightBlock}>
                  ...
                  >
                    <div>
                      ...
                      <p className={styles.inputWorkshopContact}>
                        {fields.contactName}
                      </p>
                    </div>
                    <div>
                ...
                <div className={styles.inputContainer}>
                  ...
                  <p className={styles.textArea}>{fields.deliveryData ?? ''}</p>
                </div>
              </div>
              ...
              {fields.printTasks.map((info, index) => (
                ...
                >
                  <div className={styles.contain}>
                    ...
                    <Input name={'Unidades:'} value={info.quantity} />
                    <Input name={'Medida final:'} value={info.finalSize} />
                    <Input
                      name={'Con márgenes:'}
                    ...
                    <Input name={'Gramaje:'} value={info.grammage} />
                    <Input name={'Tam. hoja:'} value={info.bulkPaperSize} />
                    <Input name={'Pliego:'} value={info.sheetSize} />
                    <Input
                      name={'Pli. x hoja:'}
                      value={info.sheetPerBulkPaper}
                    />
                    <Input name={'Unid. x pli:'} value={info.unitsPerSheet} />
                    <Input name={'Nro pliegos:'} value={info.sheetQuantity} />
                    <Input name={'Demasía:'} value={info.excess} />
                    <Input name={'Nro hojas:'} value={info.bulkPaperQuantity} />
                    <div className={styles.selectMaterialContainer}>
                    ...
                    <Input name='Chapas:' value={info.plates || ''} />

                    <Input name='Posturas:' value={info.postures || ''} />

                    <Input name='Tiraje:' value={info.printRun || ''} />

                    <Input name='Repetir:' value={info.moduleRepeat} />
                  </div>
                    ...
                    <div>
                      ...
                      >
                        <div style={{ width: '50%' }}>
                          ...
                          <p className={styles.textArea}>{info.front}</p>
                        </div>
                        <div style={{ width: '50%' }}>
                          <label className={styles.label}>Dorso:</label>
                          <p className={styles.textArea}>{info.back}</p>
                        </div>
                      </div>
                    </div>
                    <div className={styles.rightRow}>
                      <div className={styles.rightRowContainer}></div>
                      <div className={styles.rightRowContainer}></div>
                    </div>
                  </div>
                </div>
                      ...
                      <tr className={styles.tr} key={index}>
                        ...
                        <td>
                          <input
                            ...
                            name='unitType'
                            defaultValue={op.operation?.unitType ?? ''}
                            disabled
                          />
                        </td>
                        <td>
