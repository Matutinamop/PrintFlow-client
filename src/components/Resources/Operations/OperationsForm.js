...
function OperationsForm({
  ...
  const {
    ...
    setSelect,
    handleSubmit,
  } = useOperationsForm(fields, setFields, isEdit, setOpenOperationModal);

  return (
    <div className={styles.formContainer}>
      {isEdit ? <h2>Editar Operación</h2> : <h2>Nueva Operación</h2>}
      <form>
            ...
            <Select
              ...
              value={
                stationsOptions.find(
                  (station) =>
                    station.value === fields.workStation?._id ||
